...
public class ShowcaseViewBuilder {
	...
	public ShowcaseViewBuilder setText(String titleText, int subText) {
	...
	public ShowcaseViewBuilder setActivityId(int activityId) {
		showcaseView.setActivityId(activityId);
		return this;
	}

	public ShowcaseViewBuilder setCurrentPosition(int currentPosition) {
		showcaseView.setCurrentPosition(currentPosition);
		return this;
	}
	...
	public ShowcaseViewBuilder setConfigOptions(
