...
import com.stockholmapplab.recipes.nineoldandroids.util.FloatProperty;
import com.stockholmapplab.recipes.nineoldandroids.util.IntProperty;
import com.stockholmapplab.recipes.nineoldandroids.util.Property;
import com.stockholmapplab.recipes.nineoldandroids.view.animation.AnimatorProxy;
...
final class PreHoneycombCompat {
	...
	static Property<View, Float> TRANSLATION_X = new FloatProperty<View>(
			"translationX") {
		@Override
		public void setValue(View object, float value) {
	...
	static Property<View, Float> TRANSLATION_Y = new FloatProperty<View>(
			"translationY") {
		@Override
		public void setValue(View object, float value) {
	...
	static Property<View, Float> ROTATION_X = new FloatProperty<View>(
			"rotationX") {
		@Override
		public void setValue(View object, float value) {
	...
	static Property<View, Float> ROTATION_Y = new FloatProperty<View>(
			"rotationY") {
		@Override
		public void setValue(View object, float value) {
