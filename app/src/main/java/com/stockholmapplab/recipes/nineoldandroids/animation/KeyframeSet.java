...
import com.stockholmapplab.recipes.nineoldandroids.animation.Keyframe.FloatKeyframe;
import com.stockholmapplab.recipes.nineoldandroids.animation.Keyframe.IntKeyframe;
import com.stockholmapplab.recipes.nineoldandroids.animation.Keyframe.ObjectKeyframe;
	...
	public Object getValue(float fraction) {
		...
		for (int i = 1; i < mNumKeyframes; ++i) {
			...
			if (fraction < nextKeyframe.getFraction()) {
				final Interpolator interpolator = nextKeyframe
						.getInterpolator();
				if (interpolator != null) {
					fraction = interpolator.getInterpolation(fraction);
				}
