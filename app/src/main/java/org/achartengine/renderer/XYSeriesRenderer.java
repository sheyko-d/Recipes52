...
public class XYSeriesRenderer extends SimpleSeriesRenderer {
	...
	/** If the string should be displayed above the chart points. */
	private boolean mDisplayChartStrings;

	/** If the string should be displayed above the chart points. */
	private String mDisplayChartStringsText;
	...
	public static class FillOutsideLine implements Serializable {
		...
		/**
		 * Returns the fill range which is the minimum and maximum data index
		 * values for the fill.
		 * 
		...
		/**
		 * Sets the fill range which is the minimum and maximum data index
		 * values for the fill.
		 * 
		 * @param range
		 *            the fill range
	 ...
	 * with FillOutsideLine.INTEGRAL the line transforms a line chart into an
	 * area chart.
	 * 
	 * @param fill
	...
	public boolean isDisplayChartStrings() {
		return mDisplayChartStrings;
	}
	...
	public void setDisplayChartString(boolean display) {
		mDisplayChartStrings = display;
	}

	public String getDisplayChartStringsText() {
		return mDisplayChartStringsText;
	}

	public void setDisplayChartStringsText(String mDisplayChartStringsText) {
		this.mDisplayChartStringsText = mDisplayChartStringsText;
	}
